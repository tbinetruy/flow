...
from flow.envs.minicity_env import MinicityMatrixEnv, ADDITIONAL_ENV_PARAMS
from flow.scenarios.minicity import MinicityScenario, ADDITIONAL_NET_PARAMS
from flow.controllers.routing_controllers import MinicityMatrixRouter
...
flow_params = dict(
    ...
    exp_tag='udssc-matrix',

    # name of the flow environment the experiment is running on
    env_name='MinicityMatrixEnv',
